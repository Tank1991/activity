...
url = "http://testdms.maxuscloud.cn/ampService/activityWebController/queryActivityListByParam"
...
r = requests.post(url,verify = False,headers = headers ,json= body)

result = r.text
print(result)
a = json.loads(result)
print(a["data"]["totalNum"])
